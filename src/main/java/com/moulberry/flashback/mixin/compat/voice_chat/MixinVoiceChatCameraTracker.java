...
@Pseudo
@Mixin(CameraTracker.class)
public class MixinVoiceChatCameraTracker {

    @WrapOperation(method = "update", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/renderer/GameRenderer;getMainCamera()Lnet/minecraft/client/Camera;"))
