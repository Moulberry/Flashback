...
public class ImGuiHelper {
    ...
    public static boolean isBindingDown(int key) {
        if (key == 0) {
            return false;
        }
        ...
        if (key < 0) {
            ...
            int namedKey = ImGuiKeyMapping.scancodeToImGuiKey(key);
    ...
    public static boolean isBindingClicked(int key, boolean repeat) {
        if (key == 0) {
            return false;
        }
