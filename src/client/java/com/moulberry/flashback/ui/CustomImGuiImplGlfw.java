...
public class CustomImGuiImplGlfw {
    ...
    public MouseHandledBy getMouseHandledBy() {
        ...
        if (ImGui.getIO().getWantCaptureMouse()) return MouseHandledBy.IMGUI;
    ...
    public void keyCallback(final long windowId, int key, final int scancode, final int action, final int mods) {
        ...
        boolean passToMinecraft = (ReplayUI.isMainFrameHovered() && ImGui.isMouseDown(ImGuiMouseButton.Left) || !io.getWantCaptureKeyboard()) && !io.getWantTextInput();
...
//            }
    ...
    public void charCallback(final long windowId, final int c, final int mods) {
        ...
        if (!io.getWantCaptureKeyboard() && this.prevUserCallbackChar != null && windowId == this.mainWindowPtr) {
    ...
    public void enableTabInput() {
        ...
        ImGui.getIO().setKeyMap(this.keyMap);
    }
